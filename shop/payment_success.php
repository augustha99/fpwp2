						...
						<div class="navbar navbar-inverse navbar-fixed-top">
							<div class="container-fluid">	
								<div class="navbar-header">
									<a href="#" class="navbar-brand">Mitratoon</a>
								</div>
								...
								<div class="col-md-8">
									<div class="panel panel-default">
										...
										<div class="panel-body">
											<h1>Terima kasih </h1>
											<hr/>
											<p>Hallo <?php echo "<b>".$_SESSION["name"]."</b>"; ?>, Proses pemmbayaran Anda telah berhasil diselesaikan, id transaksi Anda adalah <b><?php echo $trx_id; ?></b><br/>
											Anda dapat melanjutkan belanja lagi. <br/></p>
